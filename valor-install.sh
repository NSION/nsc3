...
if [ ${1+"true"} ]; then
   ...
   if  [ $1 == "--help" ]; then
       ...
       echo ""
       echo "./valor-install.sh --help 	  'help text'"
       echo "./valor-install.sh --silent      'installation with command line parameters'"
       echo "./valor-install.sh 		  'interactive installation mode'"
       echo ""
       echo "CLI parameters usage:"
       echo "./valor-install.sh --silent <Valor release tag> <HW layout>"
       echo ""
       echo "CLI parameters example:"
       echo "./valor-install.sh --silent release-3.3 cpu"
       echo ""
       echo "./valor-install.sh --silent release-3.3"
       echo ""
       echo "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
       exit 0
   fi
